...
<ul>
	<li>The administrator site can be accessed at https://siemens.corpcoach.net/registration/admin</li>
	<li>Your user name is the email address that was used to register: {{ $admin->email }}</li>
	<li>
		To finalize your activation please 
		<a href="https://siemens.corpcoach.net/admin/set/{{ $admin->access_token }}/{{ $admin->id }}">
